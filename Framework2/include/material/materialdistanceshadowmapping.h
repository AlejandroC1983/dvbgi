...
public:
	...
	* @return true if the shader was loaded successfully, and false otherwise */
	bool loadShader()
	{
		...
		void* vertShaderCode     = InputOutput::readFile("../data/vulkanshaders/distanceshadowmapping.vert", &sizeTemp);
	...
	* @return nothing */
	...
	void setupPipelineData()
	{
		...
		m_vertexInputBindingDescription.stride    = 24; // TODO: Parameterize

		m_vertexInputAttributeDescription[0].binding  = 0;
		m_vertexInputAttributeDescription[0].location = 0;
		m_vertexInputAttributeDescription[0].format   = VK_FORMAT_R32G32B32_UINT;
		...
		m_vertexInputAttributeDescription[1].format   = VK_FORMAT_R32_UINT;
		m_vertexInputAttributeDescription[1].offset   = 12; // After, 4 components - RGB  each of 4 bytes
		m_vertexInputAttributeDescription[2].binding  = 0;
		
		m_vertexInputAttributeDescription[3].location = 2;
		m_vertexInputAttributeDescription[3].format   = VK_FORMAT_R8_UINT;
		m_vertexInputAttributeDescription[3].offset   = 16;
		m_vertexInputAttributeDescription[3].binding  = 0;

		m_vertexInputAttributeDescription[4].location = 2;
		m_vertexInputAttributeDescription[4].format   = VK_FORMAT_R8_UINT;
		m_vertexInputAttributeDescription[4].offset   = 17;
		m_vertexInputAttributeDescription[4].binding  = 0;

		m_vertexInputAttributeDescription[5].location = 2;
		m_vertexInputAttributeDescription[5].format   = VK_FORMAT_R8_UINT;
		m_vertexInputAttributeDescription[5].offset   = 18;
		m_vertexInputAttributeDescription[5].binding  = 0;

		m_vertexInputAttributeDescription[6].location = 2;
		m_vertexInputAttributeDescription[6].format   = VK_FORMAT_R8_UINT;
		m_vertexInputAttributeDescription[6].offset   = 19;
		m_vertexInputAttributeDescription[6].binding  = 0;

		m_vertexInputAttributeDescription[7].location = 2;
		m_vertexInputAttributeDescription[7].format   = VK_FORMAT_R8_UINT;
		m_vertexInputAttributeDescription[7].offset   = 20;
		m_vertexInputAttributeDescription[7].binding  = 0;

		m_vertexInputAttributeDescription[8].location = 2;
		m_vertexInputAttributeDescription[8].format   = VK_FORMAT_R8_UINT;
		m_vertexInputAttributeDescription[8].offset   = 21;
		m_vertexInputAttributeDescription[8].binding  = 0;
		...
		inputState.vertexAttributeDescriptionCount      = 9;
...
protected:
	...
	VkVertexInputAttributeDescription m_vertexInputAttributeDescription[9]; //!< This material uses a different vertex input format
