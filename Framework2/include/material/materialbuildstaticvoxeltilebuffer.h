...
#ifndef _MATERIALBUILDSTATICVOXELTILEBUFFER_H_
#define _MATERIALBUILDSTATICVOXELTILEBUFFER_H_
...
class MaterialBuildStaticVoxelTileBuffer : public Material
{
...
protected:
	...
	* @return nothing */
	MaterialBuildStaticVoxelTileBuffer(string &&name) : Material(move(name), move(string("MaterialBuildStaticVoxelTileBuffer")))
...
public:
	...
	* @return true if the shader was loaded successfully, and false otherwise */
	bool loadShader()
	{
		...
		void* shaderFirstPartCode  = InputOutput::readFile("../data/vulkanshaders/buildstaticvoxeltilebufferfirstpart.comp", &sizeFirstPart);
		void* shaderSecondPartCode = InputOutput::readFile("../data/vulkanshaders/buildstaticvoxeltilebuffersecondpart.comp", &sizeSecondPart);
		...
		m_shaderResourceName = "buildstaticvoxeltilebuffer";
	...
	* @return nothing */
	void exposeResources()
	{
		...
		assignShaderStorageBuffer(move(string("occupiedStaticVoxelTileCounterBuffer")), move(string("occupiedStaticVoxelTileCounterBuffer")), VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
		assignShaderStorageBuffer(move(string("occupiedStaticDebugBuffer")),            move(string("occupiedStaticDebugBuffer")),            VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
	}
...
#endif _MATERIALBUILDSTATICVOXELTILEBUFFER_H_
