...
#ifndef _MATERIALTEMPORALFILTERINGCLEANDYNAMIC3DTEXTURES_H_
#define _MATERIALTEMPORALFILTERINGCLEANDYNAMIC3DTEXTURES_H_
...
class MaterialTemporalFilteringCleanDynamic3DTextures: public Material
{
...
protected:
	...
	* @return nothing */
	MaterialTemporalFilteringCleanDynamic3DTextures(string &&name) : Material(move(name), move(string("MaterialTemporalFilteringCleanDynamic3DTextures")))
		...
		, m_localSizeX(1)
		, m_localSizeY(1)
		, m_coolDownTimeMs(float(gpuPipelineM->getRasterFlagValue(move(string("COOL_DOWN_TIME_MILISECONDS")))))
		, m_elapsedTime(0.0f)
	{
...
public:
	...
	* @return true if the shader was loaded successfully, and false otherwise */
	bool loadShader()
	{
		...
		void* shaderFirstPartCode  = InputOutput::readFile("../data/vulkanshaders/temporalfilteringcleandynamic3dtexturesfirstpart.comp",  &sizeFirstPart);
		void* shaderSecondPartCode = InputOutput::readFile("../data/vulkanshaders/temporalfilteringcleandynamic3dtexturessecondpart.comp", &sizeSecondPart);
		...
		m_shaderResourceName = "temporalfilteringcleandynamic3dtextures";
	...
	* @return nothing */
	void exposeResources()
	{
		...
		exposeStructField(ResourceInternalType::RIT_FLOAT,        (void*)(&m_coolDownTimeMs),            move(string("myMaterialData")), move(string("coolDownTimeMs")));
		exposeStructField(ResourceInternalType::RIT_FLOAT,        (void*)(&m_elapsedTime),               move(string("myMaterialData")), move(string("elapsedTime")));

		assignShaderStorageBuffer(move(string("dynamicIrradianceTrackingBuffer")),             move(string("dynamicIrradianceTrackingBuffer")),             VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
		...
		assignShaderStorageBuffer(move(string("dynamicIrradianceTrackingDebugBuffer")),        move(string("dynamicIrradianceTrackingDebugBuffer")),        VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
		assignShaderStorageBuffer(move(string("dynamicIrradianceTrackingCounterDebugBuffer")), move(string("dynamicIrradianceTrackingCounterDebugBuffer")), VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
	...
	* @return nothing */
	...
	{
		// TODO: This fucntion is used in many places, refactor somehow (parent material class?) and also add a variable m_bufferNumElement and call once
	...
	* @return nothing */
	...
	GETCOPY_SET(float, m_elapsedTime, ElapsedTime)
...
protected:
	...
	float  m_coolDownTimeMs;                    //!< Cool down time in miliseconds
	float  m_elapsedTime;                       //!< Elapsed time since last frame. TODO: Put this information in the scene camera uniform buffer
};

/////////////////////////////////////////////////////////////////////////////////////////////

#endif _MATERIALTEMPORALFILTERINGCLEANDYNAMIC3DTEXTURES_H_
