...
#ifndef _MATERIALPROCESSCAMERAVISIBLERESULTS_H_
#define _MATERIALPROCESSCAMERAVISIBLERESULTS_H_
...
class MaterialProcessCameraVisibleResults : public Material
{
...
protected:
	...
	* @return nothing */
	MaterialProcessCameraVisibleResults(string &&name) : Material(move(name), move(string("MaterialProcessCameraVisibleResults")))
...
public:
	...
	* @return true if the shader was loaded successfully, and false otherwise */
	bool loadShader()
	{
		...
		void* shaderFirstPartCode  = InputOutput::readFile("../data/vulkanshaders/processcameravisibleresultsfirstpart.comp",  &sizeFirstPart);
		void* shaderSecondPartCode = InputOutput::readFile("../data/vulkanshaders/processcameravisibleresultssecondpart.comp", &sizeSecondPart);
		...
		m_shaderResourceName = "processcameravisibleresults";
	...
	* @return nothing */
	void exposeResources()
	{
		...
		assignShaderStorageBuffer(move(string("staticVoxelVisibleCounterBuffer")),                  move(string("staticVoxelVisibleCounterBuffer")),                  VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
		assignShaderStorageBuffer(move(string("dynamicVoxelVisibleCounterBuffer")),                 move(string("dynamicVoxelVisibleCounterBuffer")),                 VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
		...
		assignShaderStorageBuffer(move(string("processCameraVisibleResultsDebugBuffer")),           move(string("processCameraVisibleResultsDebugBuffer")),           VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
		...
		assignShaderStorageBuffer(move(string("irradiancePaddingTagTilesCounterBuffer")),           move(string("irradiancePaddingTagTilesCounterBuffer")),           VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
		...
		assignShaderStorageBuffer(move(string("irradianceFilteringTagTilesCounterBuffer")), move(string("irradianceFilteringTagTilesCounterBuffer")), VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
	}
...
#endif _MATERIALPROCESSCAMERAVISIBLERESULTS_H_
