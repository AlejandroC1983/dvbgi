...
#ifndef _MATERIALDYNAMICSCENEVOXELIZATION_H_
#define _MATERIALDYNAMICSCENEVOXELIZATION_H_
...
class MaterialDynamicSceneVoxelization: public Material
{
...
protected:
	...
	* @return nothing */
	MaterialDynamicSceneVoxelization(string &&name) : Material(move(name), move(string("MaterialDynamicSceneVoxelization")))
...
public:
	...
	* @return true if the shader was loaded successfully, and false otherwise */
	bool loadShader()
	{
		...
		void* fragShaderCode     = InputOutput::readFile("../data/vulkanshaders/voxelizationdynamic.frag", &sizeTemp);
	...
	* @return nothing */
	void exposeResources()
	{
		...
		assignShaderStorageBuffer(move(string("dynamicVoxelizationDebugBuffer")), move(string("dynamicVoxelizationDebugBuffer")), VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
	...
	* @return nothing */
	void loadResources()
	{
		...
		// TODO: Normal texture no longer used, remove this field
...
protected:
	...
	vec4     m_sceneExtent;            //!< Extent of the scene in the xyz coordinates
};

/////////////////////////////////////////////////////////////////////////////////////////////

#endif _MATERIALDYNAMICSCENEVOXELIZATION_H_
