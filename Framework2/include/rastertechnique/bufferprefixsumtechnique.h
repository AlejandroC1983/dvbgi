...
protected:
	...
	* @return number of elements of the final compacted buffer */
	...
	Buffer*                 m_lightBounceVoxelIrradianceTempBuffer;     //!< Shader storage buffer used as a temporal copy of lightBounceVoxelIrradianceBuffer when performing the gaussian blur passes with 3^3 kernel size
