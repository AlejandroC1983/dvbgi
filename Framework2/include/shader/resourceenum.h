...
namespace resourceenum
{
	...
	* direct traslation into enum type */
	extern const string arrayResourceKeywords[121];
	...
	enum class ResourceInternalType
	{
		...
		RIT_STRUCT,
		RIT_ACCELERATION_STRUCTURE,
		RIT_COMBINED_IMAGE_SAMPLER,
		RIT_SIZE
	};
	...
	* to sort them for resource updating */
	enum class GenericResourceType
	{
		...
		GRT_NODE                         = 14,
		GRT_CAMERA                       = 15,
		GRT_ACCELERATIONSTRUCTURE        = 16,
		GRT_BASECOMPONENT                = 17,
		GRT_RENDERCOMPONENT              = 18,
		GRT_DYNAMICCOMPONENT             = 19,
		GRT_SCENEELEMENTCONTROLCOMPONENT = 20,
		GRT_SKINNEDMESHRENDERCOMPONENT   = 21,
		GRT_SKELETALANIMATION            = 22,
		GRT_SIZE                         = 23,
	};
