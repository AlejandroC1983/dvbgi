...
void VulkanStructInitializer::insertMemoryBarrier(VkAccessFlags        srcAccessMask,
												  VkAccessFlags        dstAccessMask,
												  VkPipelineStageFlags srcStageMask,
												  VkPipelineStageFlags dstStageMask,
												  VkCommandBuffer*     commandBuffer)
{
	VkMemoryBarrier memoryBarrier{ VK_STRUCTURE_TYPE_MEMORY_BARRIER, nullptr, srcAccessMask, dstAccessMask };
														...
														VkCommandBuffer*     commandBuffer)
{
	...
	forI(maxIndex)
	{
		...
		vectorBufferBarrier[i].size                = vectorBuffer[i]->getDataSize();
...
void VulkanStructInitializer::insertImageLayoutTransitionCommand(VkAccessFlags        srcAccessMask,
																 VkAccessFlags        dstAccessMask,
																 VkImageLayout        oldLayout,
																 VkImageLayout        newLayout,
																 VkPipelineStageFlags srcStageMask,
