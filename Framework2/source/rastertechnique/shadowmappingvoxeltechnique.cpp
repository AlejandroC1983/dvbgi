...
void ShadowMappingVoxelTechnique::init()
{
	...
	techniquePrefixSum->refPrefixSumComplete().connect<ShadowMappingVoxelTechnique, &ShadowMappingVoxelTechnique::slotPrefixSumCompleted>(this);
}
...
VkCommandBuffer* ShadowMappingVoxelTechnique::record(int currentImage, uint& commandBufferID, CommandBufferType& commandBufferType)
{
	...
	vkCmdDraw(*commandBuffer, m_numOccupiedVoxel * 36, 1, 0, 0);
