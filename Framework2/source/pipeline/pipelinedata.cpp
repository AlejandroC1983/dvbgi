...
void PipelineData::setDefaultValues()
{
	...
	m_vertexInputStateInfo.vertexAttributeDescriptionCount = 2; // TODO: Parameterize
...
void PipelineData::updateColorBlendStateBlendConstants(vec4 blendConstants)
{
	m_colorBlendStateInfo.blendConstants[0] = blendConstants.x;
	m_colorBlendStateInfo.blendConstants[1] = blendConstants.y;
	m_colorBlendStateInfo.blendConstants[2] = blendConstants.z;
	m_colorBlendStateInfo.blendConstants[3] = blendConstants.w;
	m_pipelineInfo.pColorBlendState         = &m_colorBlendStateInfo;
}
