...
CoreManager::CoreManager() :
	...
	, m_deviceExtensionFeatureLinkedList(nullptr)
{
...
void CoreManager::initialize()
{
	...
	s_pAccelerationStructureManager = Singleton<AccelerationStructureManager>::init();
	s_pVFP                          = Singleton<VulkanFunctionPointer>::init();
	s_pComponentManager             = Singleton<ComponentManager>::init();
	s_pSkeletalAnimationManager     = Singleton<SkeletalAnimationManager>::init();
	...
	s_pAccelerationStructureManager->assignSlots();
	...
	initializeFunctionPointerFunctions();
	...
	if (arrayGPU.size() > 0)
	{
		...
		m_physicalDevice.obtainPhysicalDeviceRayTracingPipelineProperties();

		addDeviceExtensionFeatureStruct<VkPhysicalDeviceRayTracingPipelineFeaturesKHR>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_FEATURES_KHR);
		addDeviceExtensionFeatureStruct<VkPhysicalDeviceAccelerationStructureFeaturesKHR>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_FEATURES_KHR);
		addDeviceExtensionFeatureStruct<VkPhysicalDeviceRayQueryFeaturesKHR>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR);
		addDeviceExtensionFeatureStruct<VkPhysicalDeviceBufferDeviceAddressFeatures>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES);
		addDeviceExtensionFeatureStruct<VkPhysicalDeviceScalarBlockLayoutFeaturesEXT>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES);
		addDeviceExtensionFeatureStruct<VkPhysicalDeviceDescriptorIndexingFeatures>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES);
		addDeviceExtensionFeatureStruct<VkPhysicalDevice8BitStorageFeatures>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES);
		addDeviceExtensionFeatureStruct<VkPhysicalDeviceFloat16Int8FeaturesKHR>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES);
		
		// Create Logical Device, ensure that this device is connecte to graphics queue
		m_logicalDevice.createDevice(deviceExtensionNames, m_physicalDevice.getGraphicsQueueIndex(), m_physicalDevice.getComputeQueueIndex(),  m_physicalDevice.getPhysicalDevice(), m_deviceExtensionFeatureLinkedList);

		removeDeviceExtensionFeatureStruct<VkPhysicalDeviceRayTracingPipelineFeaturesKHR>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_FEATURES_KHR);
		removeDeviceExtensionFeatureStruct<VkPhysicalDeviceAccelerationStructureFeaturesKHR>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_FEATURES_KHR);
		removeDeviceExtensionFeatureStruct<VkPhysicalDeviceRayQueryFeaturesKHR>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR);
		removeDeviceExtensionFeatureStruct<VkPhysicalDeviceBufferDeviceAddressFeatures>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES);
		removeDeviceExtensionFeatureStruct<VkPhysicalDeviceScalarBlockLayoutFeaturesEXT>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES);
		removeDeviceExtensionFeatureStruct<VkPhysicalDeviceDescriptorIndexingFeatures>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES);
		removeDeviceExtensionFeatureStruct<VkPhysicalDevice8BitStorageFeatures>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES);
		removeDeviceExtensionFeatureStruct<VkPhysicalDeviceFloat16Int8FeaturesKHR>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES);
	}
...
void CoreManager::render()
{
	...
	forI(maxIndex)
	{
		...
		{
			technique->prepare(sceneM->getDeltaTime() / 1000.0f);
...
void CoreManager::postRender()
{
	...
	{
		bufferM->printBufferResourceInformation();
		textureM->printTextureResourceInformation();
...
uint32_t CoreManager::getGraphicsQueueIndex()
{
	return m_physicalDevice.getGraphicsQueueIndex();
}

/////////////////////////////////////////////////////////////////////////////////////////////

uint32_t CoreManager::getComputeQueueIndex()
{
	return m_physicalDevice.getComputeQueueIndex();
}

/////////////////////////////////////////////////////////////////////////////////////////////

void CoreManager::initializeFunctionPointerFunctions()
{
	vkfpM->vkGetPhysicalDeviceFeatures2KHR         = reinterpret_cast<PFN_vkGetPhysicalDeviceFeatures2KHR>(        vkGetInstanceProcAddr(getInstance(), "vkGetPhysicalDeviceFeatures2KHR"));
	vkfpM->vkGetBufferDeviceAddress                = reinterpret_cast<PFN_vkGetBufferDeviceAddressKHR>(            vkGetInstanceProcAddr(getInstance(), "vkGetBufferDeviceAddress"));
	vkfpM->vkGetAccelerationStructureBuildSizesKHR = reinterpret_cast<PFN_vkGetAccelerationStructureBuildSizesKHR>(vkGetInstanceProcAddr(getInstance(), "vkGetAccelerationStructureBuildSizesKHR"));
	vkfpM->vkCreateAccelerationStructureKHR        = reinterpret_cast<PFN_vkCreateAccelerationStructureKHR>(       vkGetInstanceProcAddr(getInstance(), "vkCreateAccelerationStructureKHR"));
	vkfpM->vkCmdBuildAccelerationStructuresKHR     = reinterpret_cast<PFN_vkCmdBuildAccelerationStructuresKHR>(    vkGetInstanceProcAddr(getInstance(), "vkCmdBuildAccelerationStructuresKHR"));
	vkfpM->vkCreateRayTracingPipelinesKHR          = reinterpret_cast<PFN_vkCreateRayTracingPipelinesKHR>(         vkGetInstanceProcAddr(getInstance(), "vkCreateRayTracingPipelinesKHR"));
	vkfpM->vkGetRayTracingShaderGroupHandlesKHR    = reinterpret_cast<PFN_vkGetRayTracingShaderGroupHandlesKHR>(   vkGetInstanceProcAddr(getInstance(), "vkGetRayTracingShaderGroupHandlesKHR"));
	vkfpM->vkCmdTraceRaysKHR                       = reinterpret_cast<PFN_vkCmdTraceRaysKHR>(                      vkGetInstanceProcAddr(getInstance(), "vkCmdTraceRaysKHR"));
	vkfpM->vkCmdDebugMarkerBegin                   = reinterpret_cast<PFN_vkCmdDebugMarkerBeginEXT>(               vkGetInstanceProcAddr(getInstance(), "vkCmdDebugMarkerBeginEXT"));
	vkfpM->vkCmdDebugMarkerEnd                     = reinterpret_cast<PFN_vkCmdDebugMarkerEndEXT>(                 vkGetInstanceProcAddr(getInstance(), "vkCmdDebugMarkerEndEXT"));
	vkfpM->vkCmdDebugMarkerInsert                  = reinterpret_cast<PFN_vkCmdDebugMarkerInsertEXT>(              vkGetInstanceProcAddr(getInstance(), "vkCmdDebugMarkerInsertEXT"));
	vkfpM->vkDebugMarkerSetObjectName              = reinterpret_cast<PFN_vkDebugMarkerSetObjectNameEXT>(          vkGetInstanceProcAddr(getInstance(), "vkDebugMarkerSetObjectNameEXT"));
	vkfpM->vkDebugMarkerSetObjectTag               = reinterpret_cast<PFN_vkDebugMarkerSetObjectTagEXT>(           vkGetInstanceProcAddr(getInstance(), "vkDebugMarkerSetObjectTagEXT"));
}

/////////////////////////////////////////////////////////////////////////////////////////////

void CoreManager::setObjectName(uint64_t object, VkDebugReportObjectTypeEXT objectType, const string& name)
{
#ifdef ENABLE_DEBUG_INFORMATION
	...
	vkfpM->vkDebugMarkerSetObjectName(getLogicalDevice(), &nameInfo);
#endif
}
