...
layout (location = 1) in vec3 inUVID;
...
void main()
{
    gl_Position   = myMaterialData.viewProjection * mySceneElementTransform.model * vec4(pos, 1.0);
    worldPosition = (mySceneElementTransform.model * vec4(pos, 1.0)).xyz;
}
